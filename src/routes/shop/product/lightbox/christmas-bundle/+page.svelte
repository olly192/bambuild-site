<script>
    ...
    function submitOrder() {
        let data = formatData()
        fetch(`${env.PUBLIC_API_URL}/api/submit-order/christmas-bundle`, {
            method: "POST",
            headers: {
    ...
    {#if step === 0}
        <div id="product-main">
            <div id="preview-container">
                <span class="text-center text-gray-400">Scroll down for more previews</span>
                <div id="preview1">
            ...
            <div id="options-container">
                <div id="options-card" class="form-control">
                    <h3 class="heading-3">Customise Light Box</h3>
                    ...
                    <button class="btn btn-primary mt-4" on:click={() => step = 1}>
